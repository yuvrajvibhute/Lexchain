...
const API = import.meta.env.VITE_API_URL || (window.location.hostname === 'localhost' ? 'http://localhost:3001' : '/_/backend');
                    ...
                    <div className="login-panel" style={{ width: "100%", maxWidth: 460 }}>
                        ...
                        <div className="card-panel">
                            ...
                            <div style={{ marginBottom: 14 }}>
                                <div className="lbl">STEP 1 — CONNECT WALLET OR EMAIL <span className="req">*</span></div>
                                {!authenticated ? (
